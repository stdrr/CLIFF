...
class BaseDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Load image
        root_dir = 'images/validation_images_1280x720/validation_images_1280x720_{folder_idx}'
        folder_idx = self.imgname[index].split('/')[0].split('_')[-1]
        imgname = join(self.img_dir, root_dir.format(folder_idx=folder_idx), self.imgname[index])
        try:
