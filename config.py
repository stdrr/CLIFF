...
PW3D_ROOT = ''
UPI_S1H_ROOT = ''
AGORA_ROOT = '/media/hdd/stdrr/data/AGORA'

# Output folder to save test/train npz files
DATASET_NPZ_PATH = '/media/hdd/stdrr/data/AGORA/labels/spin_format'
...
DATASET_FILES = [ {'h36m-p1': join(DATASET_NPZ_PATH, 'h36m_valid_protocol1.npz'),
                   ...
                   'agora_validation': join(DATASET_NPZ_PATH, 'agora_validation.npz'),
                  },
